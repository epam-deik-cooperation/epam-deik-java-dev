...
class MoneyTest {
    ...
    @Test
    void testMultiplyShouldReturnTheCorrectValueWhenMultiplierIsPositive() {
        // Given
        Money underTest = new Money(100, HUF_CURRENCY);

        // when
        Money actual = underTest.multiply(2.5);

        // When - Then
        assertEquals(250, actual.amount());
        verifyNoInteractions(bank);
    }
}
